...
Gem::Specification.new do |spec|
  ...
  spec.files = `git ls-files -z`.split("\x0").select { |f| f.match(%r!^(lib|assets|_data|_layouts|_includes|_pages|LICENSE|404\.md|package\.json|tailwind\.config\.js)!) }

  spec.add_runtime_dependency "jekyll", "~> 4"
  spec.add_dependency "jekyll-tagging"
